...
window.VolumeIndicator = {
    getConfigHTML: function () {
        return `
            <div class="volume-config-container" style="padding: 12px 0; border-top: 1px solid var(--border-subtle); margin-top: 8px;">
                 <div class="indicator-params" style="display: flex; flex-direction: column; gap: 12px;">
                     <div class="param-group" style="display: flex; gap: 8px; align-items: center;">
                        ...
                        <select class="select-input condition-select" style="flex: 1;" onchange="window.VolumeIndicator.toggleInputs(this)">
                     ...
                     <div class="param-group single-input-group is-flex" style="gap: 8px; align-items: center;">
                        ...
                        <span style="font-size: 11px; color: var(--text-muted);">股</span>
                     </div>
                ...
                <div class="config-footer" style="display: flex; justify-content: flex-end; align-items: center; border-top: 1px solid var(--border-subtle); padding-top: 12px; margin-top: 12px;">
                     <div style="display: flex; gap: 8px;">
                        <button type="button" class="btn btn-sm btn-ghost btn-cancel-volume" style="padding: 4px 12px;">取消</button>
                        <button type="button" class="btn btn-sm btn-secondary btn-confirm-volume" style="padding: 4px 12px;">確定</button>
                     </div>
                </div>
            </div>
        `;
    ...
    confirmConfig: function (card) {
        ...
        const summaryHTML = `
            <div class="indicator-summary-item" data-config="${configJson}" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid var(--border-subtle);">
                <div class="summary-text" style="color: #60a5fa; font-size: 14px; font-weight: 500;">VOL: ${displayStr}</div>
