...
from App.Feature.DataManagement.sync import config
from App.Feature.DataManagement.sync.data_validator import validate_market_data
...
def incremental_update(interval: str = '1d') -> None:
    ...
    try:
        from App.Feature.DataManagement.backup.backup_mysql import backup_market_data
        backup_market_data()
    except Exception as e:
