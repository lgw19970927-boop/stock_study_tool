...
執行方式：
    ...
    python -m App.Feature.DataManagement.sync.migrate_sqlite_to_mysql
...
def main() -> None:
    ...
    from App.Feature.DataManagement.backup.backup_mysql import backup_market_data, backup_user_data
    backup_market_data()
    backup_user_data()
